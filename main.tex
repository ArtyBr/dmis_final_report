...
\centering
    ...
    \subfigure[CULane: varied conditions including night and rain.]{\includegraphics[width=0.45\textwidth]{dataset_images/Typical-video-frames-of-TuSimple-CULane-and-BDD100K-datasets-Ground-truth-lanes-are.png}}
    \caption{Example frames from the TuSimple and CULane lane detection benchmarks.}
...
Project evaluation was split into two parts: quantitative (author-labelled ground truth) and qualitative (user testing). For the quantitative portion, the author manually labelled manoeuvre events across a subset of the collected dataset and compared these labels against the system's detections. Qualitatively, user testing sessions and a general interest questionnaire were conducted.
...
A separate questionnaire was distributed more broadly through the Nextdoor neighbourhood app, LinkedIn, and the author's personal contacts. This questionnaire did not require respondents to have used the application themselves. Instead, it presented demo videos of the author's driving footage and the corresponding analysis results, then asked respondents about their driving background, dash-cam ownership, preferred recording setup, likelihood of using such a system, desired features, and willingness to pay. The questionnaire received 17 responses and the results are discussed in Section \ref{sec:questionnaire_results}.
...
The general interest questionnaire received 17 responses (16 fully licensed drivers, 1 current learner). Respondents were shown demo videos of the system analysing the author's driving footage before answering. Table~\ref{tab:survey_results} summarises the key findings.
