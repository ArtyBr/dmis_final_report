...
Project evaluation was split into two parts: quantitative (author-labelled) and qualitative (user-testing). For the quantitative portion, each component of the system was evaluated - face analysis, lane change detection and turn detection. Qualitatively, we conducted user testing as well as a general interest questionnaire. User testing was difficult to conduct for several reasons. We were limited to participants that the author knew, due to the ethical and practical concerns of general user testing. While there were many potential participants who owned cars and driver's licenses, the largest limitation was the lack of dash-cam ownership - out of 19 potential driving participants, only 5 owned dash-cams. Therefore we note that this portion of evaluation may be biased due to the personal connections of participants to the author and has limited statistical significance. \\

For quantitative testing, X clips were labelled by the author, containing Y total events (describe the events with numbers for each one). 
