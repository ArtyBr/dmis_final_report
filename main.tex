...
\centering
    \subfigure[]{\includegraphics[width=0.49\textwidth]{website_images/admin_user_accounts.png}}
    \subfigure[]{\includegraphics[width=0.49\textwidth]{website_images/admin_user_reports.png}}
    \caption{(a) Administrator view of user accounts with per-user safety event analytics. (b) User error reports dashboard showing submitted false positive and false negative reports.}
