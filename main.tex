...
These results can be compared to those of Zekany et al.\ \cite{zekany2022finding}, whose DTW-based manoeuvre classification approach was discussed in Section 2.4. Table \ref{tab:cm_comparison} presents the confusion matrices from both systems side by side for the four shared manoeuvre types, with diagonal (correct classification) percentages shown in bold where one system outperforms the other.
