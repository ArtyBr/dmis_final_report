...
\noindent the harmonic mean of precision and recall, providing a single balanced measure of overall detection quality. Per-video timeline comparisons were also generated, showing ground truth events alongside system detections with match lines and highlighted false positives/negatives, enabling visual inspection of failure cases.
...
A separate questionnaire was distributed more broadly through the Nextdoor neighbourhood app, LinkedIn, and our personal contacts. This questionnaire did not require respondents to have used the application themselves. Instead, it presented demo videos of our driving footage and the corresponding analysis results, then asked respondents about their driving background, dash-cam ownership, preferred recording setup, likelihood of using such a system, desired features, and willingness to pay. The questionnaire received 17 responses and the results are discussed in Section \ref{sec:questionnaire_results}.
...
% In this section, mention somewhere the change in safe/unsafe events before and after users did their calibrations.
